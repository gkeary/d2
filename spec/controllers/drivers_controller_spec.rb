require 'spec_helper' # This spec was generated by rspec-rails when you ran the scaffold generator.
  ...
  describe "PUT update" do
    ...
    describe "with invalid params" do
      it "assigns the driver as @driver" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Driver.any_instance.stub(:save).and_return(false)
        put :update, :id => driver.id, :driver => {}
        assigns(:driver).should eq(driver)
      end
