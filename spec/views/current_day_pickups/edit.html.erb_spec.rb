...
describe "current_day_pickups/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit current_day_pickup form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => current_day_pickups_path(@current_day_pickup), :method => "post" do
