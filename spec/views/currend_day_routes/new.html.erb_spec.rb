...
describe "currend_day_routes/new.html.erb" do
  before(:each) do
    assign(:currend_day_route, stub_model(CurrendDayRoute,
      :CurrentDayRouteID => 1,
      :CDRRouteID => "MyString",
  ...
  it "renders new currend_day_route form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => currend_day_routes_path, :method => "post" do
